...
activity4 = Activity.create!(title: "Escalade Bloc", start_date: d27, end_date: d28, description: "Pour les grimpeurs débutant ou non, je propose une après-midi escalade", price: 0, address: '42 Pl. Abel Surchamp, 33500 Libourne', user: user12, category: category1)
