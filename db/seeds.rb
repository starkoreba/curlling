...
activity4 = Activity.create!(title: "Escalade Bloc", start_date: d27, end_date: d28, description: "Pour les grimpeurs débutant ou non, je propose une après-midi escalade à la salle Arkose", price: 0, address: '170 cours du Médoc, 33300 Bordeaux', user: user1, category: category1)
