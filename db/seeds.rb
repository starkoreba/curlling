...
# --- Participations pour la dernière activité de Jean (Bowling, 2 déc) --
participation7 = Participation.create!(user: user11, activity: activity50)
participation8 = Participation.create!(user: user9, activity: activity50)
participation9 = Participation.create!(user: user3, activity: activity50)
participation10 = Participation.create!(user: user12, activity: activity50)
participation11 = Participation.create!(user: user10, activity: activity50)
puts "Finished!"
